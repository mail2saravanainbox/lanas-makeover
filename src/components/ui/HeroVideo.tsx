...
export default function HeroVideo({
  ...
  return (
    <>
      {/* The wrapper positions; EditorialImage only sizes. Passing `absolute`
          on the image itself is a coin-flip against PlaceholderPlate's own
          `relative` — it happens to work here because this parent has an
          explicit height, and it rendered 1280x0 the one time it did not. */}
